...
/**
 * Generated command class for `hg rebase`
 *
 * @generated
 * @see http://selenic.com/hg/help/rebase
 */
class libhg_Command_Rebase_Cmd extends libhg_Command_Rebase_Base {
	/**
	 ...
	 * @return libhg_Command_Rebase_Result
	 */
	public function evaluate(libhg_Stream_Readable $reader, libhg_Stream_Writable $writer, libhg_Repository_Interface $repo) {
		$output = trim($reader->readString(libhg_Stream::CHANNEL_OUTPUT));
		$code   = $reader->readReturnValue();

		return new libhg_Command_Rebase_Result($output, $code);
	}
}
